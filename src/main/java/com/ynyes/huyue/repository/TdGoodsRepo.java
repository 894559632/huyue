...
public interface TdGoodsRepo extends PagingAndSortingRepository<TdGoods, Long>, JpaSpecificationExecutor<TdGoods> {
	...
	Page<TdGoods> findByCategoryIdTreeContainingAndIsRecommendIndexTrueAndIsOnSaleTrueOrderBySortIdAsc(
			String categoryId, Pageable page);
	...
	Page<TdGoods> findByCategoryIdTreeContainingAndIsRecommendTypeTrueAndIsOnSaleTrueOrderBySortIdAsc(String categoryId,
			Pageable page);
	...
	// 分类正在秒杀
	Page<TdGoods> findByIsFlashSaleTrueAndIsOnSaleTrueAndCategoryIdTreeContainingAndFlashSaleStopTimeAfterAndFlashSaleStartTimeBeforeOrderByFlashSaleStartTimeAsc(
			String categoryId, Date current, Date current1, Pageable page);
	...
	Page<TdGoods> findByIsRecommendIndexTrueAndIsOnSaleTrueAndIsPointGoodsFalseOrderBySortIdAsc(Pageable page);
