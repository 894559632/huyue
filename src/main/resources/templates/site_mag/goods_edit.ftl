 ...
 <#--       <dl>
    ...
    <div class="tab-content" style="display: none;">
        ...
        <dl>
            <dt>销售价</dt>
            <dd>
                <input id="salePrice" name="salePrice" type="text" value="<#if goods?? && goods.salePrice??>${goods.salePrice?string("0.00")}<#else>0</#if>" class="input normal" sucmsg="">
                <span class="Validform_checktip">前台显示价格</span>
            </dd>
        </dl>
        <dl>
            <dt>积分商品</dt>
            <dd>
                <div class="rule-multi-radio multi-radio">
                    <span>
                        <input type="radio" name="isPointGoods" value="1" <#if goods?? && goods.isPointGoods?? && goods.isPointGoods==true>checked="checked"</#if>>
                        <label>是</label>
                        <input type="radio" name="isPointGoods" value="0" <#if goods??==false || goods.isPointGoods==false>checked="checked"</#if>>
                        <label>否</label>
                    </span>
                </div>
            </dd>
        ...
        <dl>
            ...
            <dd>
                ...
                <span class="Validform_checktip">积分商品购买时使用的额度</span>
            </dd>
        </dl>
        <#--
        <dl>
