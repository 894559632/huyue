            ...
            <dd style="margin-left: 50px; text-align: center;">
                <div class="order-flow" style="width: 850px">
                    ...
                    <#elseif order.statusId == 2>
                        <#if !order.isOnlinePay??||(order.isOnlinePay??&&order.isOnlinePay)>
                            <div class="order-flow-left">
                                <a class="order-flow-input"></a>
                                <span>
                                    <p class="name">订单已生成</p>
            ...
            <dd>
                <table border="0" cellspacing="0" cellpadding="0" class="border-table" width="98%">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="position">
                                <#if order.orderNumber?contains("WXDD")>
                                	微信订单
                                <#elseif order.orderNumber?contains("JFDH")>
                                	积分兑换
                            	<#elseif order.orderNumber?contains("CJDD")>
                            		抽奖订单
                                </#if>
                            </div>
                        </td>
	                        ...
	                        <td>
	                            <div class="position">
	                                <span id="spanRealAmountValue">
	                                    <#if order.pointUse??>${order.pointUse?string("0.00")}<#else>0.00</#if>
	                                </span> 
	                            </div>
	                        </td>
                        </tr>
					...
					<#if !order.orderNumber?contains("JFDH")>
	                    <tr>
	                        ...
	                        <td>
	                            <div class="position">
	                                <#if order.points??>${order.points?string("0.00")}<#else>0.00</#if>分
	                            </div>
	                        </td>
	                    </tr>
                    </#if>
                ...
                <table border="0" cellspacing="0" cellpadding="0" class="border-table" width="98%">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <span id="spanAddress">${order.shippingCity!""}</span>
                        </td>
                    </tr>
                    <tr>
                        <th>
