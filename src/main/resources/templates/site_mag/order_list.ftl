    ...
    <div class="toolbar-wrap">
        <div id="floatHead" class="toolbar">
            <div class="l-list">
                ...
                <div class="menu-list">
                    <div class="rule-single-select">
                        <select name="city" onchange="javascript:setTimeout(__doPostBack('city',''), 0)">
                             <option <#if city??><#else>selected="selected"</#if> value="">所有城市</option>
                             <#if city_list??>
                                <#list city_list as c>
                                    <option value="${c.title!""}" <#if city?? && c.title==city>selected="selected"</#if> >${c.title!""}</option>
                                </#list>
                            </#if>
                        </select>
                    </div>
