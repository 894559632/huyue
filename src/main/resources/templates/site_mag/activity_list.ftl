...
<tbody>
    <tr class="odd_bg">
        ...
        <th align="left" width="20%">中奖人</th>
        <th align="left" width="10%">中奖商品</th>
        <th align="left" width="30%">中奖时间</th>
    ...
    <#list activity_page.content as activity>
        <tr>
            ...
            <td>${activity.id?c}</td>
            <td>${activity.username!""}</a></td>
            <td>${activity.awardTitle!""}</td>
            <#--<td>
            ...
            <td><#if activity.lotteryTime??>${activity.lotteryTime?string("yyyy-MM-dd HH:mm:ss")}</#if></td>
            <#--<td>
              <div class="btn-tools">
